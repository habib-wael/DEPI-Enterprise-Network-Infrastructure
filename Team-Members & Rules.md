...
- Firewall Policies, NAT, SD-WAN, VIP
- IPsec VPN HQ Side  
- Dos Policy
...
- Layer 2 Security (DAI, Snooping, Port Security)  
...
- Branch Gateway Redundancy Logic  
...
- IPsec VPN (Branch Side)  
- Traffic Inspection & Logging , Firewall Policies, NAT, SD-WAN
- HA Cluster
---
...
- Windows Server Roles (DNS, DHCP, CA, IIS…)
